...
prehled.onAdd = function(map) {
  ...
  this._div.innerHTML =
    '<div id="prehledTable"><table><tr><td class="grey bold">ČESKÁ REPUBLIKA</td><td class="right grey bold">2019</td><td class="grey right">meziroční změna</td></tr>' +
    ...
    '<tr><td><span class="italic">údaje jsou pouze za fyzické osoby</span></td><td>&nbsp;</td><td class="right"><a id="togglePrehledLink" onclick="togglePrehled()" href="#"><img src="images/70206.png" width="12px"></a></td></tr></table></div>' +
